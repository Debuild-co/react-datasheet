      ...
      value: function onScroll(_ref4) {
        ...
        if (this.shouldCalculate) {
          ...
          this.scrollSpeedInterval = setInterval(
            function () {
              if (_this5.shouldCalculate) {
                clearInterval(_this5.scrollSpeedInterval);
                _this5.scrollSpeedInterval = null;
                // console.log('reset interval');
              }
              _this5.shouldCalculate = true;
            }.bind(this),
            ...
            _react2.default.createElement(
              ...
              function (_ref5) {
                ...
                return _react2.default.createElement(_List2.default, {
                  ...
                  onScroll: _this6.onScroll.bind(_this6),
                  rowRenderer: function rowRenderer(_ref6) {
                    ...
                    if (
                      isScrolling &&
                      (_this6.speedPer200ms || 0) > speedThreshold
                    ) {
