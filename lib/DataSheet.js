      ...
      value: function onScroll(_ref4) {
        ...
        if (this.shouldCalculate) {
          ...
          this.scrollSpeedInterval = setInterval(
            function () {
              if (_this4.shouldCalculate) {
                clearInterval(_this4.scrollSpeedInterval);
                _this4.scrollSpeedInterval = null;
                // console.log('reset interval');
              }
              _this4.shouldCalculate = true;
            }.bind(this),
            ...
            _react2.default.createElement(
              ...
              function (_ref5) {
                ...
                return _react2.default.createElement(_List2.default, {
                  ...
                  onScroll: _this5.onScroll.bind(_this5),
                  rowRenderer: function rowRenderer(_ref6) {
                    ...
                    if (
                      isScrolling &&
                      (_this5.speedPer200ms || 0) > speedThreshold
                    ) {
